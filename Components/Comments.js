...
const Comments = () => {
  ...
  <div class="mx-auto px-4">
    ...
    {commData.result?.map((comment)=>{
        return  <article class="p-6 mb-6 text-base bg-white rounded-lg dark:bg-gray-900">
        <footer class="flex justify-between items-center mb-2">
            <div class="flex items-center">
                <p class="inline-flex items-center mr-3 text-medium font-bold text-gray-900 dark:text-white"><img
                        class="mr-2 w-12 h-12 rounded-full"
                        src={`https://image.tmdb.org/t/p/w500${comment.author_details.avatar_path}`}
                        alt="Michael Gough"/>{comment.author_details.username}</p>
                <div class="text-base text-gray-600 dark:text-gray-400"><time pubdate datetime="2022-02-08"
                        title="February 8th, 2022">{comment.created_at.slice(0,10)}</time></div>
            </div>
